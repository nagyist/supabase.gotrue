...
## [2.186.0](https://github.com/nagyist/supabase.gotrue/compare/v2.185.0...v2.186.0) (2026-01-20)
...
* Add Sb-Forwarded-For header and IP-based rate limiting ([#2295](https://github.com/nagyist/supabase.gotrue/issues/2295)) ([e8f679b](https://github.com/nagyist/supabase.gotrue/commit/e8f679b9e8fcd8cb543ed43cd9cd6a73bbbf4fa7))
...
* add Supabase Auth identifier to OAuth redirect URLs ([#2299](https://github.com/nagyist/supabase.gotrue/issues/2299)) ([2d3dbc6](https://github.com/nagyist/supabase.gotrue/commit/2d3dbc652c1beb47c2eade28b45e94f6e2c56982))
...
* allow amr claim to be array of strings or objects ([#2274](https://github.com/nagyist/supabase.gotrue/issues/2274)) ([607da43](https://github.com/nagyist/supabase.gotrue/commit/607da43b697b0af1de0da5f966f5b63ff033fefb))
...
* async, concurrent index creation for users table ([#2239](https://github.com/nagyist/supabase.gotrue/issues/2239)) ([a1146bf](https://github.com/nagyist/supabase.gotrue/commit/a1146bf7eecb35e237350dda7ae62328cbb5acfe))
...
* increment refresh token counter by 2 for mfa verify ([#2284](https://github.com/nagyist/supabase.gotrue/issues/2284)) ([2a38668](https://github.com/nagyist/supabase.gotrue/commit/2a3866854fe7cb58a6cb84e7a82ce5d07bb920ee))
* **indexworker:** use `auth_trgm` extension if available ([#2263](https://github.com/nagyist/supabase.gotrue/issues/2263)) ([05daa43](https://github.com/nagyist/supabase.gotrue/commit/05daa437131bd220e01a0e33df75f4b9afa72bb6))
...
* load template cache at startup for fault tolerance ([#2261](https://github.com/nagyist/supabase.gotrue/issues/2261)) ([511c3a4](https://github.com/nagyist/supabase.gotrue/commit/511c3a4e12819d313840cd5342ae6a76d4708cfc))
...
* **oauth:** add support for X/Twitter v2 provider ([#2275](https://github.com/nagyist/supabase.gotrue/issues/2275)) ([7f36eb0](https://github.com/nagyist/supabase.gotrue/commit/7f36eb053286038d01ba1650dd48a15508550ce0))
* **oauthserver:** add authorization list and revoke endpoints ([#2232](https://github.com/nagyist/supabase.gotrue/issues/2232)) ([cc640b2](https://github.com/nagyist/supabase.gotrue/commit/cc640b277989d57b39f3805cd9433ef4fe16bf83))
...
* **oauthserver:** add OpenID Connect support ([#2250](https://github.com/nagyist/supabase.gotrue/issues/2250)) ([162788f](https://github.com/nagyist/supabase.gotrue/commit/162788ff960c060318324f11f673c09c0da41d5e))
* **oauthserver:** update oauth grant list & authorization details response structure ([#2247](https://github.com/nagyist/supabase.gotrue/issues/2247)) ([137ea92](https://github.com/nagyist/supabase.gotrue/commit/137ea92c00a0c1a7654fb8bcf0c1b5313901349f))
* **oauthserver:** use `NewOAuthServerAuthorizationParams` & configurable ttl for authorization ([#2254](https://github.com/nagyist/supabase.gotrue/issues/2254)) ([61632f8](https://github.com/nagyist/supabase.gotrue/commit/61632f8c0401b6c816ea7427d351ec623ce5258f))
...
* properly handle redirect url fragments and unusual hostnames ([#2200](https://github.com/nagyist/supabase.gotrue/issues/2200)) ([aa0ac5b](https://github.com/nagyist/supabase.gotrue/commit/aa0ac5b9a8af26d4b779e48ec4da2ab06a6dc15e))
...
* replace JWT OAuth state with `flow_state.id` UUID ([#2331](https://github.com/nagyist/supabase.gotrue/issues/2331)) ([645654d](https://github.com/nagyist/supabase.gotrue/commit/645654df63a3da7929840659c065f6a9cdd4ba96))
* reset main branch to 2.185.0 ([#2325](https://github.com/nagyist/supabase.gotrue/issues/2325)) ([b9d0500](https://github.com/nagyist/supabase.gotrue/commit/b9d050029ce90efc083f08a1e8df629faf20e8cd))
...
* support multiple `aud` for the external providers ([#2117](https://github.com/nagyist/supabase.gotrue/issues/2117)) ([ca5792e](https://github.com/nagyist/supabase.gotrue/commit/ca5792e41a48f20a395646015c28ce272355bf63))
...
* Treat rate limit header value as comma-separated list ([#2282](https://github.com/nagyist/supabase.gotrue/issues/2282)) ([5f2e279](https://github.com/nagyist/supabase.gotrue/commit/5f2e2792560d57dd14fbf3e69c133a7ec8518c4d))
...
* additional provider and issuer checks ([#2326](https://github.com/nagyist/supabase.gotrue/issues/2326)) ([cb79a74](https://github.com/nagyist/supabase.gotrue/commit/cb79a7414e8b2bff30113bdf2b9ec6d6e93c1146))
...
* check each type independently ([#2290](https://github.com/nagyist/supabase.gotrue/issues/2290)) ([d9de0af](https://github.com/nagyist/supabase.gotrue/commit/d9de0af3a173ae3e9ab0219c07652675f8be1761))
...
* fix the wrong error return value ([#1950](https://github.com/nagyist/supabase.gotrue/issues/1950)) ([e2dfb5d](https://github.com/nagyist/supabase.gotrue/commit/e2dfb5d4222e5edc569b54d057db9ed4375a19d8))
...
* hostname can be empty with redirect urls ([#2241](https://github.com/nagyist/supabase.gotrue/issues/2241)) ([f5a4cba](https://github.com/nagyist/supabase.gotrue/commit/f5a4cbac73de28cc4b04c5c9725b70517cb131d3))
...
* **indexworker:** detect which schema `pg_trgm` exists in ([#2260](https://github.com/nagyist/supabase.gotrue/issues/2260)) ([4be12b3](https://github.com/nagyist/supabase.gotrue/commit/4be12b3e7c0a30b1e289ab81348548f72ab32ba5))
* **indexworker:** remove pg_trgm extension ([#2301](https://github.com/nagyist/supabase.gotrue/issues/2301)) ([c553b10](https://github.com/nagyist/supabase.gotrue/commit/c553b10e5f3b7a8c430b20babe0e7c96178b1c91))
...
* japanese dot example fix ([#2243](https://github.com/nagyist/supabase.gotrue/issues/2243)) ([3a5f4b2](https://github.com/nagyist/supabase.gotrue/commit/3a5f4b211a0f50bd1957f5a41467fc5aa6a01ca6))
...
* look for refresh token on mfa verification only in v1 ([#2249](https://github.com/nagyist/supabase.gotrue/issues/2249)) ([2906b24](https://github.com/nagyist/supabase.gotrue/commit/2906b2424d0aa804031e66cf92f008289b8a9c77))
...
* mfa verify now works with refresh token algorithm v2 ([#2246](https://github.com/nagyist/supabase.gotrue/issues/2246)) ([4e8275f](https://github.com/nagyist/supabase.gotrue/commit/4e8275f915c4d84186d17b41c86a9277055a55e4))
...
* **oauth-server:** allow custom URI schemes in client redirect URIs ([#2298](https://github.com/nagyist/supabase.gotrue/issues/2298)) ([ea72f57](https://github.com/nagyist/supabase.gotrue/commit/ea72f57f99633b33cc7b30b4a0b74ed8314b71e6))
...
* **social-auth:** default to current_user:read for Figma provider ([#2195](https://github.com/nagyist/supabase.gotrue/issues/2195)) ([f409d11](https://github.com/nagyist/supabase.gotrue/commit/f409d118ebb958c12f2395c0bf4fb9590ab6c0af))
...
* tighten email validation rules ([#2304](https://github.com/nagyist/supabase.gotrue/issues/2304)) ([33bb372](https://github.com/nagyist/supabase.gotrue/commit/33bb37203ae54c7ddecb6373122fae4b4fd38682))
